...
/* ================================================================
   HABIT / STREAK - Be U
   Contador de dias consecutivos de reflexion.
   Un "dia" = al menos una reflexion completada.
   ================================================================ */

var Habit = (function () {

  var KEYS = { STREAK: 'beu_streak', LAST: 'beu_streak_last' };
  ...
  function getStreak()   { return parseInt(localStorage.getItem(KEYS.STREAK) || '0', 10); }
  function getLastDate() { return localStorage.getItem(KEYS.LAST) || ''; }
  ...
  function recordReflection() {
    ...
    if (last === today)  return streak;         // ya registrado hoy
    if (last === yest)   streak++;              // dia consecutivo
    else                 streak = 1;            // reinicio
  ...
  return { getStreak: getStreak, recordReflection: recordReflection, getStreakMessage: getStreakMessage };
